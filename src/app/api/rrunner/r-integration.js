 ...
 * @returns {{string, string}} the command execution result
 */
 const executeShellCommandAsync = (command) => {
 ...
 */
const executeRCommandAsync = (command, RBinariesLocation) => {
 ...
 */
const callMethodAsync = (fileLocation, methodName, params, RBinariesLocation) => {
	return new Promise(function(resolve, reject) {
